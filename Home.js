  ...
  return (
    <div id="App-content">
      ...
      <div className="App-section">
        <p style={{fontStyle: "italic", fontWeight: "bold", fontSize: "1.1em", color: "red"}}>Please note that this site is still under development; the 'Register' and 'Login' buttons are not yet operable.
        </p>
        ...
        <p>Membership of Oxfordshire Jazz Federation costs only £5 a year, renewable on April 1st.  Musicians and supporters are invited to join us to get advance notice of gigs and to help spread the word about Jazz in Oxfordshire and neighbouring counties.
        {/* If you're already a member, use the green "Login" button above, otherwise use the "Register" button and supply your name and email address to be added to the list. */}
        </p>
        <p>&nbsp;</p>
      </div>
      <div className="App-section">
