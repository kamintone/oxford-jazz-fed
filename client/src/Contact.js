  ...
  return (
    <div id="App-content">
      <div id="contact-details" className="App-section">
        ...
        <hr />
        <p>Judy Eames<br/>
          <a className="btn emailButton" href="mailto:jude@judyeames.co.uk">Email Judy</a></p>
        <hr />
        <p>Tony Davis<br/>
          <a className="btn emailButton" href="mailto:tony@tony-davis.co.uk">Email Tony</a></p>
        <br />
      </div>
    </div>
  );
